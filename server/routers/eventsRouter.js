...
const { getAllEvents, createEvent, getEventById, putEvent, deleteEvent } = require("./eventController");
const { protectRoute, isAuthorised } = require("../server/controllers/authController");
